...
<REGISTRY_DOCKERHUB>/python:3.11-slim        # MCP/agent/admin/mock 빌드 베이스
...
(베이스 이미지는 `python:3.11-slim` — 옛 pip는 3.12에서 `pkgutil.ImpImporter` 에러로 못 돎. 자세한 건 `docs/CLAUDE-GUIDE.md` 3장.)
